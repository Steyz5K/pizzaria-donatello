...
$('section.testemunha').waypoint(function (direcao) {
    ...
    if (direcao == 'up') {
        $('div.testemunhos ul:eq(0)').removeClass('animate__animated animate_fadeInUp animate__slower');
        $('div.testemunhos ul:eq(1)').removeClass('animate__animated animate_fadeInUp animate__slower');
        $('div.testemunhos ul:eq(2)').removeClass('animate__animated animate_fadeInUp animate__slower');
    }


}, { offset: '400px' })

$('div.pizza-opcoes-mestre').waypoint(function (direcao) {
    if (direcao == 'down') {
        $('div.pizza-opcoes').addClass('animate__animated animate__fadeInUp');
        $('div.pizza-opcoes').addClass('animate__animated animate__fadeInUp animate');
        $('div.pizza-opcoes').addClass('animate__animated animate__fadeInUp');
        $('div.pizza-opcoes').addClass('animate__animated animate__fadeInUp');
    }
    if (direcao == 'up') {
        $('div.pizza-opcoes').removeClass('animate__animated animate_fadeInUp animate__slower');
        $('div.pizza-opcoes ').removeClass('animate__animated animate_fadeInUp animate__slower');
        $('div.pizza-opcoes').removeClass('animate__animated animate_fadeInUp animate__slower');
        $('div.pizza-opcoes').removeClass('animate__animated animate_fadeInUp animate__slower');
    }
...
$('section.plano-principal').waypoint(function (direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(1)').removeClass('animate__animated animate__FadeInUp');
